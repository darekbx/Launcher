...
public class BufferCreator {
    ...
    public float[] createVertexBuffer(int[] positions, int[][] imageData) {
        ...
        for (int i = 0; i < count; i += 3) {
            ...
            int colorValue = imageData[positionX][positionY];
    ...
    public float[] createColorBuffer(float[] positions, int[][] imageData) {
        final int length = positions.length;
        ...
        for (int i = 0; i < count; i += 4) {
            int colorValue = imageData[(int) positions[index++]][(int) positions[index++]];
